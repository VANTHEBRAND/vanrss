  ...
  render() {
    ...
    >
      ...
      <div className="mt-4 text-xs text-helper-color">
        vanfeed will automatically add 3rd-party tracking urls (e.g., podtrac, chartable...) before the url of a media file, so you can easily track download stats. This is a <a href="https://lowerstreet.co/blog/podcast-tracking" target="_blank" rel="noopener noreferrer">common practice in the podcast industry</a>.
      </div>
